  ...
  Photon = function (super$) {
    ...
    Photon.prototype.monitor = function (args, done) {
      ...
      monitor = function (this$) {
        return function () {
          this$.status(args, function (this$1) {
            return function (err, status) {
              ...
              if (!(null != err)) {
                ...
                if (ID_WIFI_SSID !== this$1.config.wifi.ssid)
                  this$1.emit('lost_configuration', status);
                if (ID_WIMAX_STATUS === 'CONNECTED' && (null != this$1.previousStatus ? this$1.previousStatus.ID_WIMAX_STATUS : void 0) === 'CONNECTING')
                  this$1.emit('connected', status);
                if (ID_WIMAX_STATUS !== 'CONNECTED' && (null != this$1.previousStatus ? this$1.previousStatus.ID_WIMAX_STATUS : void 0) === 'CONNECTED')
                  this$1.emit('disconnected', status);
                return this$1.previousStatus = status;
              }
            };
          }(this$));
